...
# as defined by the node rpcchainvm.
# ref. https://github.com/luxfi/node/blob/v1.9.11/version/constants.go#L15-L17
PROTOCOL_VERSION='26'
...
buf export buf.build/luxfi/lux:v"${PROTOCOL_VERSION}" -o ./protos/lux
