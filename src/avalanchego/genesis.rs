...
/// Represents Lux network genesis configuration.
/// ref. <https://pkg.go.dev/github.com/luxfi/node/genesis#Config>
...
impl Genesis {
    ...
    pub fn new<T: key::secp256k1::ReadOnly>(network_id: u32, seed_keys: &[T]) -> io::Result<Self> {
        ...
        for k in seed_keys.iter() {
            ...
            xp_alloc.lux_addr = Some(k.hrp_address(network_id, "X").unwrap());
    ...
    pub fn sync(&self, file_path: &str) -> io::Result<()> {
        ...
        let genesis_file = GenesisFile {
            ...
            // the node can only read string-format c-chain genesis
            c_chain_genesis,
...
/// ref. <https://pkg.go.dev/github.com/luxfi/node/genesis#Allocation>
#[derive(Debug, Serialize, Deserialize, Eq, PartialEq, Clone)]
pub struct Allocation {
    #[serde(rename = "luxAddr", skip_serializing_if = "Option::is_none")]
    pub lux_addr: Option<String>,
    /// "eth_addr" can be any value, not used in "node".
...
/// ref. <https://pkg.go.dev/github.com/luxfi/node/genesis#LockedAmount>
#[derive(Debug, Serialize, Deserialize, Eq, PartialEq, Clone)]
...
/// ref. <https://pkg.go.dev/github.com/luxfi/node/genesis#Staker>
#[derive(Debug, Serialize, Deserialize, Eq, PartialEq, Clone)]
pub struct Staker {
