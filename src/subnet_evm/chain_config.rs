...
/// ref. <https://pkg.go.dev/github.com/luxfi/subnet-evm/plugin/evm#Config>
/// ref. <https://pkg.go.dev/github.com/luxfi/subnet-evm/plugin/evm#Config.SetDefaults>
/// ref. <https://github.com/luxfi/subnet-evm/blob/v0.4.8/plugin/evm/config.go>
...
/// $ vi /data/lux-configs/chains/2ebCneCbwthjQ1rYT41nhd7M76Hc6YmosMAQrTFhBq8qeqh6tt/config.json
///
...
pub const DEFAULT_PROFILE_DIR: &str = "/var/log/node-profile/coreth";
...
impl Config {
    ...
    pub fn default() -> Self {
        Self {
            ...
            rpc_tx_fee_cap: Some(100f64),  // 100 LUX
            ...
            // ref. <https://pkg.go.dev/github.com/luxfi/subnet-evm/core#DefaultTxPoolConfig>
...
/// RUST_LOG=debug cargo test --package lux-types --lib --features="subnet_evm" -- subnet_evm::chain_config::test_config --exact --show-output
#[test]
fn test_config() {
