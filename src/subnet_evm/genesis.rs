...
/// ref. <https://pkg.go.dev/github.com/luxfi/subnet-evm/core#Genesis>
/// ref. <https://pkg.go.dev/github.com/luxfi/subnet-evm/params#ChainConfig>
...
pub struct Genesis {
    ...
    /// ref. <https://github.com/luxfi/subnet-evm/pull/63>
    ///
    ...
    /// ref. <https://docs.lux.network/subnets/customize-a-subnet#setting-the-genesis-allocation>
    #[serde(skip_serializing_if = "Option::is_none")]
...
/// "0x204FCE5E3E25026110000000" is "10000000000000000000000000000" (10,000,000,000 LUX).
...
impl Genesis {
    pub fn default() -> Self {
        ...
        alloc.insert(
            // ref. https://github.com/luxfi/subnet-evm/blob/master/networks/11111/genesis.json
...
/// ref. <https://pkg.go.dev/github.com/luxfi/subnet-evm/params#ChainConfig>
/// ref. <https://pkg.go.dev/github.com/luxfi/subnet-evm/params#pkg-variables>
#[derive(Debug, Serialize, Deserialize, Eq, PartialEq, Clone)]
#[serde(rename_all = "camelCase")]
pub struct ChainConfig {
    ...
    /// ref. <https://docs.lux.network/subnets/customize-a-subnet>
    #[serde(skip_serializing_if = "Option::is_none")]
...
impl ChainConfig {
    ...
    pub fn default() -> Self {
        Self {
            ...
            // ref. <https://github.com/luxfi/coreth/blob/v0.8.6/plugin/evm/vm.go#L326-L328>
            // ref. <https://github.com/luxfi/lux-ops/issues/8>
...
/// ref. <https://pkg.go.dev/github.com/luxfi/subnet-evm/commontype#FeeConfig>
/// ref. <https://pkg.go.dev/github.com/luxfi/subnet-evm/params#pkg-variables>
#[derive(Debug, Serialize, Deserialize, Eq, PartialEq, Clone)]
#[serde(rename_all = "camelCase")]
...
impl FeeConfig {
    /// ref. <https://github.com/luxfi/public-chain-assets/blob/main/chains/53935/genesis.json>
    /// ref. <https://pkg.go.dev/github.com/luxfi/subnet-evm/params#pkg-variables>
    /// ref. <https://github.com/luxfi/subnet-evm/blob/master/scripts/run.sh>
    /// ref. <https://www.rapidtables.com/convert/number/decimal-to-hex.html>
    /// ref. <https://www.rapidtables.com/convert/number/hex-to-decimal.html>
    pub fn default() -> Self {
        Self {
...
/// ref. <https://github.com/luxfi/subnet-evm/blob/master/precompile/contract_deployer_allow_list.go>
/// ref. <https://github.com/luxfi/subnet-evm/blob/master/precompile/upgradeable.go>
/// ref. <https://github.com/luxfi/subnet-evm/blob/master/params/precompile_config.go>
#[derive(Debug, Serialize, Deserialize, Eq, PartialEq, Clone)]
#[serde(rename_all = "camelCase")]
...
/// ref. <https://github.com/luxfi/subnet-evm/blob/master/precompile/contract_native_minter.go>
/// ref. <https://github.com/luxfi/subnet-evm/blob/master/precompile/upgradeable.go>
/// ref. <https://github.com/luxfi/subnet-evm/blob/master/params/precompile_config.go>
#[derive(Debug, Serialize, Deserialize, Eq, PartialEq, Clone)]
#[serde(rename_all = "camelCase")]
...
/// ref. <https://github.com/luxfi/subnet-evm/blob/master/precompile/tx_allow_list.go>
/// ref. <https://github.com/luxfi/subnet-evm/blob/master/precompile/upgradeable.go>
/// ref. <https://github.com/luxfi/subnet-evm/blob/master/params/precompile_config.go>
#[derive(Debug, Serialize, Deserialize, Eq, PartialEq, Clone)]
#[serde(rename_all = "camelCase")]
...
/// ref. <https://github.com/luxfi/subnet-evm/blob/master/precompile/fee_config_manager.go>
/// ref. <https://github.com/luxfi/subnet-evm/blob/master/precompile/upgradeable.go>
/// ref. <https://github.com/luxfi/subnet-evm/blob/master/params/precompile_config.go>
#[derive(Debug, Serialize, Deserialize, Eq, PartialEq, Clone)]
#[serde(rename_all = "camelCase")]
...
/// ref. <https://pkg.go.dev/github.com/luxfi/subnet-evm/core#GenesisAlloc>
/// ref. <https://pkg.go.dev/github.com/luxfi/subnet-evm/core#GenesisAccount>
#[derive(Debug, Serialize, Deserialize, Eq, PartialEq, Clone)]
#[serde(rename_all = "camelCase")]
pub struct AllocAccount {
    ...
    /// ref. <https://pkg.go.dev/github.com/luxfi/subnet-evm/core#GenesisMultiCoinBalance>
    #[serde(skip_serializing_if = "Option::is_none")]
...
/// RUST_LOG=debug cargo test --package lux-types --lib -- subnet_evm::genesis::test_parse --exact --show-output
#[test]
fn test_parse() {
