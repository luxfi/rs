...
/// ref. <https://pkg.go.dev/github.com/luxfi/node/utils/formatting#EncodeWithChecksum>
/// ref. <https://pkg.go.dev/github.com/luxfi/node/utils/hashing#Checksum>
...
/// ref. <https://pkg.go.dev/github.com/luxfi/node/utils/formatting#Decode>
...
/// RUST_LOG=debug cargo test --package lux-types --lib -- formatting::test_encode_c58_with_checksum --exact --show-output
#[test]
fn test_encode_c58_with_checksum() {
    // ref. <https://github.com/luxfi/node/blob/v1.9.7/utils/formatting/encoding_test.go#>
...
/// RUST_LOG=debug cargo test --package lux-types --lib -- formatting::test_encode_hex_with_checksum --exact --show-output
#[test]
...
/// ref. <https://pkg.go.dev/github.com/luxfi/node/utils/formatting#FormatAddress>
/// ref. <https://pkg.go.dev/github.com/luxfi/node/utils/formatting#FormatBech32>
