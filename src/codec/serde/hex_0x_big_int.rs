...
/// RUST_LOG=debug cargo test --package lux-types --lib -- codec::serde::hex_0x_big_int::test_custom_de_serializer --exact --show-output
#[test]
...
/// "0x52B7D2DCC80CD2E4000000" is "100000000000000000000000000" (100,000,000 LUX).
