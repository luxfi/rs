...
lazy_static! {
    /// ref. <https://pkg.go.dev/github.com/luxfi/node/codec#Registry>
    /// ref. <https://github.com/luxfi/node/blob/v1.9.11/vms/avm/txs/codec.go>
    /// ref. <https://github.com/luxfi/node/blob/v1.7.9/vms/avm/codec_registry.go>
    /// ref. <https://github.com/luxfi/node/blob/v1.7.9/codec/reflectcodec/type_codec.go#L128-L131>
    ...
    /// ref. <https://github.com/luxfi/node/blob/v1.9.11/vms/platformvm/txs/codec.go>
    ///     (used for encoding Go interface type into a "struct")
