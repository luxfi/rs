...
/// RUST_LOG=debug cargo test --package lux-types --lib -- key::secp256k1::public_key::test_public_key --exact --show-output
#[test]
fn test_public_key() {
    ...
    let x_lux_addr = pubkey1.to_hrp_address(1, "X").unwrap();
    let p_lux_addr = pubkey1.to_hrp_address(1, "P").unwrap();
...
/// RUST_LOG=debug cargo test --package lux-types --lib -- key::secp256k1::signature::test_key_serialization --exact --show-output
#[test]
