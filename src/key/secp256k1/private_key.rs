...
impl Key {
    ...
    /// Loads the private key from a CB58-encoded string (e.g., Lux).
...
/// RUST_LOG=debug cargo test --package lux-types --lib -- key::secp256k1::private_key::test_private_key --exact --show-output
#[test]
fn test_private_key() {
