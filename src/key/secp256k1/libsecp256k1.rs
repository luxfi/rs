...
impl PrivateKey {
    ...
    /// Encodes the raw private key to string with "PrivateKey-" prefix (e.g., Lux).
...
/// RUST_LOG=debug cargo test --package lux-types --lib -- key::secp256k1::libsecp256k1::test_key --exact --show-output
#[test]
fn test_key() {
