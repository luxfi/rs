...
/// ref. <https://pkg.go.dev/github.com/luxfi/node/vms/avm/fxs#FxCredential>
/// ref. <https://pkg.go.dev/github.com/luxfi/node/vms/components/verify#Verifiable>
/// ref. <https://pkg.go.dev/github.com/luxfi/node/vms/secp256k1fx#Credential>
#[serde_as]
#[derive(Debug, Serialize, Deserialize, Eq, Clone)]
pub struct Credential {
    /// Signatures, each must be length of 65.
    /// ref. <https://pkg.go.dev/github.com/luxfi/node/utils/crypto#SECP256K1RSigLen>
...
/// RUST_LOG=debug cargo test --package lux-types --lib -- key::secp256k1::txs::test_credential_custom_de_serializer --exact --show-output
#[test]
...
/// RUST_LOG=debug cargo test --package lux-types --lib -- key::secp256k1::txs::test_sort_credentials --exact --show-output
#[test]
...
/// ref. <https://pkg.go.dev/github.com/luxfi/node/vms/platformvm/fx#Owner>
...
/// RUST_LOG=debug cargo test --package lux-types --lib -- key::secp256k1::txs::test_sort_output_owners --exact --show-output
#[test]
...
/// RUST_LOG=debug cargo test --package lux-types --lib -- key::secp256k1::txs::test_sort_inputs --exact --show-output
#[test]
fn test_sort_inputs() {
