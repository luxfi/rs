...
pub struct Output {
    ...
    /// The custom de/serializer embeds "output_owners" at the same level as "amount" as in node.
    #[serde(flatten)]
...
/// RUST_LOG=debug cargo test --package lux-types --lib -- key::secp256k1::txs::transfer::test_transfer_output_custom_de_serializer --exact --show-output
#[test]
...
/// RUST_LOG=debug cargo test --package lux-types --lib -- key::secp256k1::txs::transfer::test_sort_transfer_outputs --exact --show-output
#[test]
...
/// RUST_LOG=debug cargo test --package lux-types --lib -- key::secp256k1::txs::transfer::test_sort_transfer_inputs --exact --show-output
#[test]
