...
/// ref. "node/utils/crypto/bls.SecretKeyLen"
...
lazy_static! {
    ...
    /// ref. "node/utils/crypto/bls.ciphersuiteSignature"
...
impl Key {
    ...
    /// ref. "node/utils/crypto/bls.SecretKey.Sign"
    pub fn sign(&self, msg: &[u8]) -> Signature {
        self.0.sign(msg, &CIPHER_SUITE_SIGNATURE, &[]).into()
    }

    /// ref. "node/utils/crypto/bls.SecretKey.SignProofOfPossession"
    ...
    /// ref. "node"/vms/platformvm/signer.NewProofOfPossession"
...
/// RUST_LOG=debug cargo test --package lux-types --lib -- key::bls::private_key::test_key --exact --show-output
#[test]
fn test_key() {
