...
impl Sig {
    ...
    /// ref. "node/utils/crypto/bls.SignatureToBytes"
    ...
    /// ref. "node/utils/crypto/bls.Verify"
    ...
    /// Verifies the message and the validity of its signature.
    /// Invariant: [pubkey] and [self.0] have both been validated.
    /// ref. "node/utils/crypto/bls.VerifyProofOfPossession"
...
/// RUST_LOG=debug cargo test --package lux-types --lib -- key::bls::signature::test_signature --exact --show-output
#[test]
fn test_signature() {
