...
/// ref. <https://github.com/luxfi/xsvm/blob/master/genesis/genesis.go>
...
impl Genesis {
    ...
    /// ref. <https://pkg.go.dev/github.com/luxfi/node/codec#Manager>
...
/// RUST_LOG=debug cargo test --package lux-types --lib --features="evm" -- xsvm::genesis::test_encode_packer_bytes --exact --show-output
#[test]
...
/// RUST_LOG=debug cargo test --package lux-types --lib -- xsvm::genesis::test_parse --exact --show-output
#[test]
fn test_parse() {
    let _ = env_logger::builder().is_test(true).try_init();
