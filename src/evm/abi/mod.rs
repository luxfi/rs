...
/// RUST_LOG=debug cargo test --package lux-types --lib --features="evm" -- evm::abi::test_encode_calldata_register_name --exact --show-output
#[test]
...
/// RUST_LOG=debug cargo test --package lux-types --lib --features="evm" -- evm::abi::test_encode_calldata_register_mint --exact --show-output
#[test]
...
/// RUST_LOG=debug cargo test --package lux-types --lib --features="evm" -- evm::abi::test_encode_calldata_send --exact --show-output
#[test]
...
/// RUST_LOG=debug cargo test --package lux-types --lib --features="evm" -- evm::abi::test_encode_calldata_forward_request --exact --show-output
#[test]
