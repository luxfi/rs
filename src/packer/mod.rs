...
/// ref. <https://pkg.go.dev/github.com/luxfi/node/utils/wrappers#Packer>
...
impl Packer {
    ...
    /// ref. "node/utils/wrappers.Packer.Expand"
    /// ref. <https://pkg.go.dev/github.com/luxfi/node/utils/wrappers#Packer.Expand>
    pub fn expand(&self, n: usize) -> Result<()> {
        ...
        // "node/utils/wrappers.Packer.Expand" is different in that
    ...
    /// ref. "node/utils/wrappers.Packer.CheckSpace"
    /// ref. <https://pkg.go.dev/github.com/luxfi/node/utils/wrappers#Packer.CheckSpace>
    ...
    /// ref. "node/utils/wrappers.Packer.PackByte"
    /// ref. <https://pkg.go.dev/github.com/luxfi/node/utils/wrappers#Packer.PackByte>
    ...
    /// ref. "node/utils/wrappers.Packer.UnpackByte"
    /// ref. <https://pkg.go.dev/github.com/luxfi/node/utils/wrappers#Packer.UnpackByte>
    ...
    /// ref. "node/utils/wrappers.Packer.PackShort"
    /// ref. <https://pkg.go.dev/github.com/luxfi/node/utils/wrappers#Packer.PackShort>
    ...
    /// and advances the cursor and offset.
    /// ref. "node/utils/wrappers.Packer.UnpackShort"
    /// ref. <https://pkg.go.dev/github.com/luxfi/node/utils/wrappers#Packer.UnpackShort>
    ...
    /// ref. "node/utils/wrappers.Packer.PackInt"
    /// ref. <https://pkg.go.dev/github.com/luxfi/node/utils/wrappers#Packer.PackInt>
    ...
    /// and advances the cursor and offset.
    /// ref. "node/utils/wrappers.Packer.UnpackInt"
    /// ref. <https://pkg.go.dev/github.com/luxfi/node/utils/wrappers#Packer.UnpackInt>
    ...
    /// ref. "node/utils/wrappers.Packer.PackLong"
    /// ref. <https://pkg.go.dev/github.com/luxfi/node/utils/wrappers#Packer.PackLong>
    ...
    /// and advances the cursor and offset.
    /// ref. "node/utils/wrappers.Packer.UnpackLong"
    /// ref. <https://pkg.go.dev/github.com/luxfi/node/utils/wrappers#Packer.UnpackLong>
    ...
    /// ref. "node/utils/wrappers.Packer.PackBool"
    /// ref. <https://pkg.go.dev/github.com/luxfi/node/utils/wrappers#Packer.PackBool>
    ...
    /// and advances the cursor and offset.
    /// ref. "node/utils/wrappers.Packer.UnpackBool"
    /// ref. <https://pkg.go.dev/github.com/luxfi/node/utils/wrappers#Packer.UnpackBool>
    ...
    /// ref. "node/utils/wrappers.Packer.PackFixedBytes"
    /// ref. <https://pkg.go.dev/github.com/luxfi/node/utils/wrappers#Packer.PackFixedBytes>
    ...
    /// and advances the cursor and offset.
    /// ref. "node/utils/wrappers.Packer.UnpackFixedBytes"
    /// ref. <https://pkg.go.dev/github.com/luxfi/node/utils/wrappers#Packer.UnpackFixedBytes>
    ...
    /// ref. "node/utils/wrappers.Packer.PackBytes"
    /// ref. <https://pkg.go.dev/github.com/luxfi/node/utils/wrappers#Packer.PackBytes>
    ...
    /// and advances the cursor and offset.
    /// ref. "node/utils/wrappers.Packer.UnpackBytes"
    /// ref. <https://pkg.go.dev/github.com/luxfi/node/utils/wrappers#Packer.UnpackBytes>
    ...
    /// ref. "node/utils/wrappers.Packer.PackFixedByteSlices"
    /// ref. <https://pkg.go.dev/github.com/luxfi/node/utils/wrappers#Packer.PackFixedByteSlices>
    ...
    /// and advances the cursor and offset.
    /// ref. "node/utils/wrappers.Packer.UnpackFixedByteSlices"
    /// ref. <https://pkg.go.dev/github.com/luxfi/node/utils/wrappers#Packer.UnpackFixedByteSlices>
    ...
    /// Writes the two-dimensional "u8" slice from the offset and increments the offset as much.
    /// ref. "node/utils/wrappers.Packer.Pack2DByteSlice"
    /// ref. <https://pkg.go.dev/github.com/luxfi/node/utils/wrappers#Packer.Pack2DByteSlice>
    ...
    /// Unpacks the two-dimensional "u8" slice from the "offset" position,
    /// and advances the cursor and offset.
    /// ref. "node/utils/wrappers.Packer.Unpack2DByteSlice"
    /// ref. <https://pkg.go.dev/github.com/luxfi/node/utils/wrappers#Packer.Unpack2DByteSlice>
    ...
    /// ref. "node/utils/wrappers.Packer.PackStr"
    /// ref. <https://pkg.go.dev/github.com/luxfi/node/utils/wrappers#Packer.PackStr>
    ...
    /// ref. "node/utils/wrappers.Packer.UnpackStr"
    ///
    ...
    ///
    /// ref. <https://pkg.go.dev/github.com/luxfi/node/utils/wrappers#Packer.UnpackStr>
...
/// RUST_LOG=debug cargo test --package lux-types --lib -- packer::test_expand --exact --show-output
/// ref. "node/utils/wrappers.TestPackerExpand"
#[test]
fn test_expand() {
    let s = vec![0x01];
...
/// RUST_LOG=debug cargo test --package lux-types --lib -- packer::test_packer_from_bytes --exact --show-output
#[test]
...
/// RUST_LOG=debug cargo test --package lux-types --lib -- packer::test_pack_byte --exact --show-output
/// ref. "node/utils/wrappers.TestPackerPackByte"
#[test]
fn test_pack_byte() {
...
/// RUST_LOG=debug cargo test --package lux-types --lib -- packer::test_unpack_byte --exact --show-output
/// ref. "node/utils/wrappers.TestPackerUnpackByte"
#[test]
fn test_unpack_byte() {
    let s = vec![0x01];
    let b = BytesMut::from(&s[..]);
...
/// RUST_LOG=debug cargo test --package lux-types --lib -- packer::test_pack_u16 --exact --show-output
/// ref. "node/utils/wrappers.TestPackerPackShort"
#[test]
fn test_pack_u16() {
    let packer = Packer {
        max_size: U16_LEN,
...
/// RUST_LOG=debug cargo test --package lux-types --lib -- packer::test_unpack_u16 --exact --show-output
/// ref. "node/utils/wrappers.TestPackerUnpackShort"
#[test]
fn test_unpack_u16() {
...
/// RUST_LOG=debug cargo test --package lux-types --lib -- packer::test_pack_u16_short --exact --show-output
/// ref. "node/utils/wrappers.TestPacker"
#[test]
...
/// RUST_LOG=debug cargo test --package lux-types --lib -- packer::test_pack_u32 --exact --show-output
/// ref. "node/utils/wrappers.TestPackerPackInt"
#[test]
fn test_pack_u32() {
    let packer = Packer {
        max_size: U32_LEN,
...
/// RUST_LOG=debug cargo test --package lux-types --lib -- packer::test_unpack_u32 --exact --show-output
/// ref. "node/utils/wrappers.TestPackerUnpackInt"
#[test]
fn test_unpack_u32() {
...
/// RUST_LOG=debug cargo test --package lux-types --lib -- packer::test_pack_u64 --exact --show-output
/// ref. "node/utils/wrappers.TestPackerPackLong"
#[test]
fn test_pack_u64() {
    let packer = Packer {
        max_size: U64_LEN,
...
/// RUST_LOG=debug cargo test --package lux-types --lib -- packer::test_unpack_u64 --exact --show-output
/// ref. "node/utils/wrappers.TestPackerUnpackLong"
#[test]
fn test_unpack_u64() {
...
/// RUST_LOG=debug cargo test --package lux-types --lib -- packer::test_pack_bool --exact --show-output
/// ref. "node/utils/wrappers.TestPackBool"
/// ref. "node/utils/wrappers.TestPackerPackBool"
#[test]
fn test_pack_bool() {
    let packer = Packer {
        max_size: 3,
...
/// RUST_LOG=debug cargo test --package lux-types --lib -- packer::test_unpack_bool --exact --show-output
/// ref. "node/utils/wrappers.TestPackBool"
/// ref. "node/utils/wrappers.TestPackerUnpackBool"
#[test]
fn test_unpack_bool() {
    let s = vec![0x01];
    let b = BytesMut::from(&s[..]);
...
/// RUST_LOG=debug cargo test --package lux-types --lib -- packer::test_pack_bytes --exact --show-output
/// ref. "node/utils/wrappers.TestPackerPackFixedBytes"
#[test]
fn test_pack_bytes() {
    let packer = Packer {
        max_size: 8,
...
/// RUST_LOG=debug cargo test --package lux-types --lib -- packer::test_unpack_bytes --exact --show-output
/// ref. "node/utils/wrappers.TestPackerUnpackFixedBytes"
#[test]
...
/// RUST_LOG=debug cargo test --package lux-types --lib -- packer::test_pack_bytes_with_header --exact --show-output
/// ref. "node/utils/wrappers.TestPackerPackBytes"
#[test]
fn test_pack_bytes_with_header() {
    ...
    let b = packer.take_bytes();
    assert_eq!(&b[..], b"\x00\x00\x00\x04Lux");
...
/// RUST_LOG=debug cargo test --package lux-types --lib -- packer::test_unpack_bytes_with_header --exact --show-output
/// ref. "node/utils/wrappers.TestPackerUnpackBytes"
#[test]
...
/// RUST_LOG=debug cargo test --package lux-types --lib -- packer::test_pack_2d_bytes --exact --show-output
/// ref. "node/utils/wrappers.TestPackerPackFixedByteSlices"
#[test]
fn test_pack_2d_bytes() {
    ...
    let b = packer.take_bytes();
    assert_eq!(&b[..], b"\x00\x00\x00\x02LuxEvax");
...
/// RUST_LOG=debug cargo test --package lux-types --lib -- packer::test_unpack_2d_bytes --exact --show-output
/// ref. "node/utils/wrappers.TestPackerUnpackFixedByteSlices"
#[test]
...
/// RUST_LOG=debug cargo test --package lux-types --lib -- packer::test_pack_2d_bytes_with_header --exact --show-output
#[test]
fn test_pack_2d_bytes_with_header() {
    ...
    assert_eq!(
        &b[..],
        b"\x00\x00\x00\x02\x00\x00\x00\x04Lux\x00\x00\x00\x04Evax"
    );
    let expected = vec![
...
/// RUST_LOG=debug cargo test --package lux-types --lib -- packer::test_unpack_2d_bytes_with_header --exact --show-output
#[test]
...
/// RUST_LOG=debug cargo test --package lux-types --lib -- packer::test_pack_2d_bytes_with_header_123 --exact --show-output
/// ref. "node/utils/wrappers.TestPacker2DByteSlice"
#[test]
...
/// RUST_LOG=debug cargo test --package lux-types --lib -- packer::test_pack_str --exact --show-output
/// ref. "node/utils/wrappers.TestPackerString"
#[test]
fn test_pack_str() {
    let packer = Packer {
        max_size: 6,
