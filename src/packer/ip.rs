...
impl Packer {
    ...
    /// ref. "node/utils/wrappers.Packer.PackIP"
    /// ref. <https://pkg.go.dev/github.com/luxfi/node/utils/wrappers#Packer.PackIP>
    ...
    pub fn pack_ip(&self, ip_addr: IpAddr, port: u16) -> Result<()> {
        let ip_bytes = match ip_addr {
            IpAddr::V4(v) => {
                // "node" encodes IPv4 address as it is
    ...
    /// ref. "node/utils/wrappers.Packer.UnpackIP"
    /// ref. <https://pkg.go.dev/github.com/luxfi/node/utils/wrappers#Packer.UnpackIP>
    ...
    /// ref. "node/utils/wrappers.Packer.PackIPs"
    /// ref. <https://pkg.go.dev/github.com/luxfi/node/utils/wrappers#Packer.PackIPs>
    ...
    /// and advances the cursor and offset.
    /// ref. "node/utils/wrappers.Packer.UnpackIPs"
    /// ref. <https://pkg.go.dev/github.com/luxfi/node/utils/wrappers#Packer.UnpackIPs>
...
/// RUST_LOG=debug cargo test --package lux-types --lib -- packer::ip::test_pack_and_unpack --exact --show-output
/// ref. "node/utils/wrappers.TestPackIPCert"
#[test]
...
/// RUST_LOG=debug cargo test --package lux-types --lib -- packer::ip::test_packs_and_unpacks --exact --show-output
#[test]
