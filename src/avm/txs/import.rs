...
/// ref. <https://pkg.go.dev/github.com/luxfi/node/vms/avm#Tx>
/// ref. <https://pkg.go.dev/github.com/luxfi/node/vms/avm#ImportTx>
/// ref. <https://pkg.go.dev/github.com/luxfi/node/vms/avm#UnsignedTx>
...
impl Tx {
    ...
    /// ref. <https://pkg.go.dev/github.com/luxfi/node/vms/avm#Tx.SignSECP256K1Fx>
...
/// RUST_LOG=debug cargo test --package lux-types --lib -- avm::txs::import::test_import_tx_serialization_with_two_signers --exact --show-output
/// ref. "node/vms/avm.TestImportTxSerialization"
#[test]
fn test_import_tx_serialization_with_two_signers() {
    ...
    let expected_signed_bytes: &[u8] = &[
        ...
        0x00, 0x00, 0x00, 0x00, //
        //
        // number of of credentials (lux.Tx.fx_creds.len())
        0x00, 0x00, 0x00, 0x02, //
        //
        //
        // NOTE: fx_id is serialize:"false"
