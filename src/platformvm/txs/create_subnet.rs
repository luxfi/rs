...
/// ref. <https://pkg.go.dev/github.com/luxfi/node/vms/platformvm/txs#CreateSubnetTx>
...
/// RUST_LOG=debug cargo test --package lux-types --lib -- platformvm::txs::create_subnet::test_create_subnet_tx_serialization_with_one_signer --exact --show-output
#[test]
...
/// RUST_LOG=debug cargo test --package lux-types --lib -- platformvm::txs::create_subnet::test_create_subnet_tx_serialization_with_custom_network --exact --show-output
#[test]
