...
/// ref. <https://github.com/luxfi/node/blob/master/vms/platformvm/txs/add_permissionless_validator_tx.go>
/// ref. <https://pkg.go.dev/github.com/luxfi/node/vms/platformvm/txs#AddPermissionlessValidatorTx>
/// ref. <https://pkg.go.dev/github.com/luxfi/node/vms/platformvm/txs#Tx>
/// ref. <https://pkg.go.dev/github.com/luxfi/node/vms/platformvm/txs#UnsignedTx>
#[derive(Debug, Serialize, Deserialize, Eq, PartialEq, Clone)]
#[serde(rename_all = "camelCase")]
pub struct Tx {
    /// The transaction ID is empty for unsigned tx
    /// as long as "lux.BaseTx.Metadata" is "None".
    ...
    /// ref. "github.com/luxfi/node/utils/constants.PrimaryNetworkID" (ids.Empty).
...
impl Tx {
    ...
    /// ref. <https://pkg.go.dev/github.com/luxfi/node/vms/platformvm/txs#Tx.Sign>
    /// ref. <https://pkg.go.dev/github.com/luxfi/node/utils/crypto#PrivateKeyED25519.SignHash>
    pub async fn sign<T: key::secp256k1::SignOnly + Clone>(
        ...
        // "node" marshals the whole struct again for signed bytes
        // even when the underlying "unsigned_tx" is already once marshaled
        // ref. https://pkg.go.dev/github.com/luxfi/node/vms/platformvm#Tx.Sign
        //
        ...
        // ref. https://pkg.go.dev/github.com/luxfi/node/vms/platformvm#UnsignedAddPermissionlessValidatorTx
        ...
        // ref. "node/vms/platformvm.Tx.Sign"
        // ref. "node/vms/components/lux.BaseTx.Metadata.Initialize"
...
/// RUST_LOG=debug cargo test --package lux-types --lib -- platformvm::txs::add_permissionless_validator::test_add_permissionless_validator_tx_serialization_with_one_signer --exact --show-output
#[test]
