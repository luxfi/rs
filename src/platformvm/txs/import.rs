...
/// ref. <https://pkg.go.dev/github.com/luxfi/node/vms/platformvm/txs#ImportTx>
...
impl Tx {
    ...
    pub async fn sign<T: key::secp256k1::SignOnly>(&mut self, signers: Vec<Vec<T>>) -> Result<()> {
        ...
        // ref. https://pkg.go.dev/github.com/luxfi/node/vms/platformvm#UnsignedImportTx
        ...
        // ref. "node/vms/platformvm.Tx.SignSECP256K1Fx"
...
/// RUST_LOG=debug cargo test --package lux-types --lib -- platformvm::txs::import::test_import_tx_serialization_with_one_signer --exact --show-output
/// ref. "node/vms/platformvm.TestNewImportTx"
#[test]
fn test_import_tx_serialization_with_one_signer() {
    ...
    // ref. "node/vms/platformvm/vm_test.go"
    ...
    let expected_signed_bytes: &[u8] = &[
        ...
        //
        //
        // number of of credentials (lux.Tx.creds.len())
        0x00, 0x00, 0x00, 0x01, //
        //
        //
        // NOTE: fx_id is serialize:"false"
