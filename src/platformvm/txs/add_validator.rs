...
/// ref. <https://pkg.go.dev/github.com/luxfi/node/vms/platformvm/txs#AddValidatorTx>
...
impl Tx {
    ...
    pub async fn sign<T: key::secp256k1::SignOnly + Clone>(
        ...
        // ref. https://pkg.go.dev/github.com/luxfi/node/vms/platformvm#UnsignedAddValidatorTx
...
/// RUST_LOG=debug cargo test --package lux-types --lib -- platformvm::txs::add_validator::test_add_validator_tx_serialization_with_one_signer --exact --show-output
#[test]
