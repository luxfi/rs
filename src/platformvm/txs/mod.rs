...
/// RUST_LOG=debug cargo test --package lux-types --lib -- platformvm::txs::test_json_deserialize --exact --show-output
#[test]
...
/// RUST_LOG=debug cargo test --package lux-types --lib -- platformvm::txs::test_sort_stakeable_lock_ins --exact --show-output
#[test]
...
/// RUST_LOG=debug cargo test --package lux-types --lib -- platformvm::txs::test_sort_stakeable_lock_outs --exact --show-output
#[test]
...
/// ref. <https://pkg.go.dev/github.com/luxfi/node/vms/platformvm#Validator>
/// ref. <https://pkg.go.dev/github.com/luxfi/node/vms/platformvm#AddValidatorArgs>
/// ref. <https://pkg.go.dev/github.com/luxfi/node/vms/platformvm/api#Staker>
