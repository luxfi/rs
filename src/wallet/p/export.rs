...
/// ref. <https://github.com/luxfi/node/blob/v1.9.4/wallet/chain/p/builder.go> "NewExportTx"
/// ref. <https://github.com/luxfi/node/blob/v1.9.4/vms/platformvm/txs/builder/builder.go> "NewExportTx"
#[derive(Clone, Debug)]
pub struct Tx<T>
where
