...
/// ref. <https://github.com/luxfi/node/blob/v1.9.4/wallet/chain/p/builder.go#L500-L525> "NewCreateSubnetTx"
/// ref. <https://github.com/luxfi/node/blob/v1.9.4/vms/platformvm/txs/builder/builder.go#L392> "NewCreateSubnetTx"
#[derive(Clone, Debug)]
pub struct Tx<T>
where
