...
/// ref. <https://github.com/luxfi/node/blob/v1.9.4/wallet/chain/p/builder.go#L459-L498> "NewCreateChainTx"
/// ref. <https://github.com/luxfi/node/blob/v1.9.4/vms/platformvm/txs/builder/builder.go#L345> "NewCreateChainTx"
#[derive(Clone, Debug)]
pub struct Tx<T>
where
