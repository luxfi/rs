...
// ref. <https://docs.lux.network/quickstart/adjusting-gas-price-during-high-network-activity>
lazy_static! {
...
/// ref. <https://pkg.go.dev/github.com/luxfi/subnet-evm/core/types#DynamicFeeTx>
#[derive(Clone, Debug)]
pub struct Tx<T, S>
where
    T: key::secp256k1::ReadOnly + key::secp256k1::SignOnly + Clone,
