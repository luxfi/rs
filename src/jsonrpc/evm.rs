...
/// RUST_LOG=debug cargo test --package lux-types --lib -- jsonrpc::evm::test_block_number --exact --show-output
#[test]
...
/// RUST_LOG=debug cargo test --package lux-types --lib -- jsonrpc::evm::test_chain_id --exact --show-output
#[test]
fn test_chain_id() {
...
/// RUST_LOG=debug cargo test --package lux-types --lib -- jsonrpc::evm::test_gas_price --exact --show-output
#[test]
fn test_gas_price() {
...
/// RUST_LOG=debug cargo test --package lux-types --lib -- jsonrpc::evm::test_get_balance --exact --show-output
#[test]
fn test_get_balance() {
    // ref. https://docs.lux.network/build/node-apis/c-chain#eth_getassetbalance
...
/// RUST_LOG=debug cargo test --package lux-types --lib -- jsonrpc::evm::test_get_transaction_count --exact --show-output
#[test]
...
/// RUST_LOG=debug cargo test --package lux-types --lib -- jsonrpc::evm::test_get_transaction_receipt --exact --show-output
#[test]
...
/// RUST_LOG=debug cargo test --package lux-types --lib -- jsonrpc::evm::test_send_raw_transaction --exact --show-output
#[test]
