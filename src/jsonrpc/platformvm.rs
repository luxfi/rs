...
/// ref. <https://docs.lux.network/apis/node/apis/p-chain#platformissuetx>
...
/// RUST_LOG=debug cargo test --package lux-types --lib -- jsonrpc::platformvm::test_issue_tx --exact --show-output
#[test]
fn test_issue_tx() {
    use std::str::FromStr;
...
/// RUST_LOG=debug cargo test --package lux-types --lib -- jsonrpc::platformvm::test_get_tx --exact --show-output
#[test]
fn test_get_tx() {
...
/// RUST_LOG=debug cargo test --package lux-types --lib -- jsonrpc::platformvm::test_get_tx_status --exact --show-output
#[test]
...
/// RUST_LOG=debug cargo test --package lux-types --lib -- jsonrpc::platformvm::test_get_height --exact --show-output
#[test]
fn test_get_height() {
    // ref. https://docs.lux.network/build/node-apis/p-chain/#platformgetheight
...
/// ref. <https://docs.lux.network/apis/node/apis/p-chain#platformgetutxos>
#[derive(Debug, Serialize, Deserialize, Eq, PartialEq, Clone)]
#[serde(rename_all = "camelCase")]
...
/// RUST_LOG=debug cargo test --package lux-types --lib -- jsonrpc::platformvm::test_get_utxos_empty --exact --show-output
#[test]
...
/// RUST_LOG=debug cargo test --package lux-types --lib -- jsonrpc::platformvm::test_get_utxos_non_empty --exact --show-output
#[test]
...

{
    ...
    \"result\": {
        ...
        \"endIndex\": {
            \"address\": \"X-lux1x459sj0ssujguq723cljfty4jlae28evjzt7xz\",
...
",
    ...
    let expected = GetUtxosResponse {
        ...
        result: Some(GetUtxosResult {
            ...
            utxos: Some(vec![utxo]),
            end_index: Some(super::EndIndex {
                address: String::from("X-lux1x459sj0ssujguq723cljfty4jlae28evjzt7xz"),
...
/// RUST_LOG=debug cargo test --package lux-types --lib -- jsonrpc::platformvm::test_get_balance --exact --show-output
#[test]
fn test_get_balance() {
    use crate::ids;
    use std::str::FromStr;
...
/// ref. <https://docs.lux.network/apis/node/apis/p-chain#platformgetcurrentvalidators>
...
/// ref. <https://docs.lux.network/apis/node/apis/p-chain#platformgetpendingvalidators>
#[derive(Debug, Serialize, Deserialize, PartialEq, Clone)]
...
/// ref. <https://docs.lux.network/apis/node/apis/p-chain#platformgetpendingvalidators>
/// ref. <https://pkg.go.dev/github.com/luxfi/node/vms/platformvm#ClientPermissionlessValidator>
/// ref. <https://pkg.go.dev/github.com/luxfi/node/vms/platformvm#ClientStaker>
...
/// ref. <https://pkg.go.dev/github.com/luxfi/node/vms/platformvm#APIOwner>
#[serde_as]
#[derive(Debug, Serialize, Deserialize, Eq, PartialEq, Clone)]
pub struct ApiOwner {
    #[serde_as(as = "DisplayFromStr")]
...
/// RUST_LOG=debug cargo test --package lux-types --lib -- jsonrpc::platformvm::test_get_current_validators --exact --show-output
#[test]
...
/// RUST_LOG=debug cargo test --package lux-types --lib -- jsonrpc::platformvm::test_get_pending_validators --exact --show-output
#[test]
...
/// ref. <https://pkg.go.dev/github.com/luxfi/node/vms/platformvm#APIUTXO>
#[serde_as]
#[derive(Debug, Serialize, Deserialize, Eq, PartialEq, Clone)]
pub struct ApiUtxo {
    #[serde_as(as = "DisplayFromStr")]
...
/// RUST_LOG=debug cargo test --package lux-types --lib -- jsonrpc::platformvm::test_get_subnets --exact --show-output
#[test]
fn test_get_subnets() {
    use crate::ids;
    use std::str::FromStr;
...
/// RUST_LOG=debug cargo test --package lux-types --lib -- jsonrpc::platformvm::test_get_blockchains --exact --show-output
#[test]
...
/// RUST_LOG=debug cargo test --package lux-types --lib -- jsonrpc::platformvm::test_get_blockchain_status --exact --show-output
#[test]
