...
/// RUST_LOG=debug cargo test --package lux-types --lib -- jsonrpc::info::test_get_network_id --exact --show-output
#[test]
...
/// RUST_LOG=debug cargo test --package lux-types --lib -- jsonrpc::info::test_get_blockchain_id --exact --show-output
#[test]
...
/// RUST_LOG=debug cargo test --package lux-types --lib -- jsonrpc::info::test_get_node_id --exact --show-output
#[test]
fn test_get_node_id() {
    use std::str::FromStr;
...
/// ref. <https://docs.lux.network/build/node-apis/info/#infogetnodeip>
#[derive(Debug, Serialize, Deserialize, Eq, PartialEq, Clone)]
...
/// RUST_LOG=debug cargo test --package lux-types --lib -- jsonrpc::info::test_get_node_version --exact --show-output
#[test]
...
"#,
    ...
    let expected = GetNodeVersionResponse {
        ...
        result: Some(GetNodeVersionResult {
            version: String::from("lux/1.10.1"),
...
/// RUST_LOG=debug cargo test --package lux-types --lib -- jsonrpc::info::test_get_tx_fee --exact --show-output
#[test]
fn test_get_tx_fee() {
    // ref. <https://docs.lux.network/build/node-apis/info/#infogettxfee>
...
/// ref. <https://docs.lux.network/apis/node/apis/info#infouptime>
...
/// RUST_LOG=debug cargo test --package lux-types --lib -- jsonrpc::info::test_uptime --exact --show-output
#[test]
fn test_uptime() {
    // ref. https://docs.lux.network/apis/node/apis/info#infouptime
...
/// ref. <https://docs.lux.network/apis/node/apis/info#infopeers>
#[derive(Debug, Serialize, Deserialize, Eq, PartialEq, Clone)]
...
/// RUST_LOG=debug cargo test --package lux-types --lib -- jsonrpc::info::test_peers --exact --show-output
#[test]
fn test_peers() {
    use std::str::FromStr;
