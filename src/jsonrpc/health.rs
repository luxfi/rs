...
/// Represents LuxGo health status.
/// ref. <https://pkg.go.dev/github.com/luxfi/node/api/health#APIHealthReply>
...
/// Represents LuxGo health status.
/// ref. <https://pkg.go.dev/github.com/luxfi/node/api/health#Result>
#[serde_as]
#[derive(Debug, Deserialize, Eq, PartialEq, Clone)]
...
/// RUST_LOG=debug cargo test --package lux-types --lib -- jsonrpc::health::test_parse --exact --show-output
#[test]
fn test_parse() {
    use log::info;
