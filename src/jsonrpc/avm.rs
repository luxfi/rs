...
/// ref. <https://docs.lux.network/apis/node/apis/x-chain#avmissuetx>
...
/// RUST_LOG=debug cargo test --package lux-types --lib -- jsonrpc::avm::test_issue_tx --exact --show-output
#[test]
fn test_issue_tx() {
    use std::str::FromStr;
...
/// ref. <https://docs.lux.network/apis/node/apis/x-chain/#avmgettxstatus>
#[derive(Debug, Serialize, Deserialize, Eq, PartialEq, Clone)]
...
/// RUST_LOG=debug cargo test --package lux-types --lib -- jsonrpc::avm::test_get_tx_status --exact --show-output
#[test]
...
/// RUST_LOG=debug cargo test --package lux-types --lib -- jsonrpc::avm::test_get_utxos_empty --exact --show-output
#[test]
...
/// RUST_LOG=debug cargo test --package lux-types --lib -- jsonrpc::avm::test_get_utxos_non_empty --exact --show-output
#[test]
...
/// ref. <https://docs.lux.network/build/node-apis/x-chain#avmgetbalance>
#[derive(Debug, Serialize, Deserialize, Eq, PartialEq, Clone)]
...
/// RUST_LOG=debug cargo test --package lux-types --lib -- jsonrpc::avm::test_get_balance --exact --show-output
#[test]
fn test_get_balance() {
    use std::str::FromStr;
...
/// ref. <https://docs.lux.network/build/node-apis/x-chain/#avmgetassetdescription>
#[derive(Debug, Serialize, Deserialize, Eq, PartialEq, Clone)]
...
/// RUST_LOG=debug cargo test --package lux-types --lib -- jsonrpc::avm::test_get_asset_description --exact --show-output
#[test]
