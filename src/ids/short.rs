...
impl Id {
        ...
        S: AsRef<[u8]>,
    {
        ...
        // "ids.Id.String"
        // ref. https://pkg.go.dev/github.com/luxfi/node/ids#Id.String
...
impl<'de> Deserialize<'de> for Id {
        ...
        D: Deserializer<'de>,
    {
        ...
        let addr = ss[1];
        let (_, short_bytes) = secp256k1::address::lux_address_to_short_bytes("", addr)
...
/// RUST_LOG=debug cargo test --package lux-types --lib -- ids::short::test_serialize --exact --show-output
#[test]
fn test_serialize() {
...
/// RUST_LOG=debug cargo test --package lux-types --lib -- ids::short::test_id --exact --show-output
#[test]
fn test_id() {
    let id = Id::from_slice(&<Vec<u8>>::from([
        0x3d, 0x0a, 0xd1, 0x2b, 0x8e, 0xe8, 0x92, 0x8e, 0xdf, 0x24, //
...
/// RUST_LOG=debug cargo test --package lux-types --lib -- ids::short::test_sort --exact --show-output
#[test]
fn test_sort() {
