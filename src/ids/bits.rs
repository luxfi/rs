...
/// ref. <https://pkg.go.dev/github.com/luxfi/node/ids#EqualSubset>
...
/// RUST_LOG=debug cargo test --package lux-types --lib -- ids::bits::test_equal_subset --exact --show-output
#[test]
...
/// RUST_LOG=debug cargo test --package lux-types --lib -- ids::bits::test_equal_subset_same_byte --exact --show-output
...
/// RUST_LOG=debug cargo test --package lux-types --lib -- ids::bits::test_equal_subset_bad_middle --exact --show-output
...
/// RUST_LOG=debug cargo test --package lux-types --lib -- ids::bits::test_equal_subset_out_of_bounds --exact --show-output
...
/// This does bit-per-bit comparison for the Id type of [u8; ID_LEN].
/// ref. <https://pkg.go.dev/github.com/luxfi/node/ids#FirstDifferenceSubset>
...
/// RUST_LOG=debug cargo test --package lux-types --lib -- ids::bits::test_first_difference_subset --exact --show-output
#[test]
...
/// RUST_LOG=debug cargo test --package lux-types --lib -- ids::bits::test_first_difference_equal_byte_5 --exact --show-output
...
/// RUST_LOG=debug cargo test --package lux-types --lib -- ids::bits::test_first_difference_subset_middle --exact --show-output
...
/// RUST_LOG=debug cargo test --package lux-types --lib -- ids::bits::test_first_difference_vacuous --exact --show-output
...
/// ref. <https://pkg.go.dev/github.com/luxfi/node/ids#BitSet64>
...
/// RUST_LOG=debug cargo test --package lux-types --lib -- ids::bits::test_bit_set --exact --show-output
#[test]
fn test_bit_set() {
