//! The `ids` implements Lux ID type (32-byte).
//!
//! ```
//! use lux_types::ids;
//!
...
/// ref. <https://pkg.go.dev/github.com/luxfi/node/ids#ID>
...
impl Id {
    ...
    /// ref. <https://pkg.go.dev/github.com/luxfi/node/ids#ToID>
    ...
    /// ref. <https://pkg.go.dev/github.com/luxfi/node/ids#ID.Bit>
...
/// RUST_LOG=debug cargo test --package lux-types --lib -- ids::test_custom_de_serializer --exact --show-output
#[test]
...
/// RUST_LOG=debug cargo test --package lux-types --lib -- ids::test_serialize --exact --show-output
#[test]
fn test_serialize() {
...
/// Set is a set of Ids.
/// https://pkg.go.dev/github.com/luxfi/node/ids#Set
...
/// RUST_LOG=debug cargo test --package lux-types --lib -- ids::test_id --exact --show-output
/// ref. "node/ids.TestIDMarshalJSON"
#[test]
fn test_id() {
    let id = Id::from_slice(&<Vec<u8>>::from([
        0x3d, 0x0a, 0xd1, 0x2b, 0x8e, 0xe8, 0x92, 0x8e, 0xdf, 0x24, //
...
/// RUST_LOG=debug cargo test --package lux-types --lib -- ids::test_sort --exact --show-output
#[test]
fn test_sort() {
...
/// RUST_LOG=debug cargo test --package lux-types --lib -- ids::test_vm_id --exact --show-output
#[test]
fn test_vm_id() {
    use log::info;
