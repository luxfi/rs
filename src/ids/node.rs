...
/// ref. <https://pkg.go.dev/github.com/luxfi/node/ids#ShortID>
...
impl Id {
    ...
    /// ref. <https://pkg.go.dev/github.com/luxfi/node/node#Node.Initialize>
    ...
    /// ref. <https://pkg.go.dev/github.com/luxfi/node/utils/hashing#PubkeyBytesToAddress>
    /// ref. <https://pkg.go.dev/github.com/luxfi/node/ids#ToShortID>
...
/// RUST_LOG=debug cargo test --package lux-types --lib -- ids::node::test_custom_de_serializer --exact --show-output
#[test]
...
/// RUST_LOG=debug cargo test --package lux-types --lib -- ids::node::test_serialize --exact --show-output
#[test]
fn test_serialize() {
...
/// ref. <https://pkg.go.dev/github.com/luxfi/node/ids#NewNodeIDSet>
...
/// RUST_LOG=debug cargo test --package lux-types --lib -- ids::node::test_from_cert_file --exact --show-output
#[test]
fn test_from_cert_file() {
    ...
    // copied from "node/staking/local/staking1.key,crt"
    // verified by "node-compatibility/node-id" for compatibility with Go
...
/// RUST_LOG=debug cargo test --package lux-types --lib -- ids::node::test_sort --exact --show-output
#[test]
fn test_sort() {
