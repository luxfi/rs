...
/// ref. <https://pkg.go.dev/github.com/luxfi/node/ids#Bag>
pub struct Bag {
...
/// RUST_LOG=debug cargo test --package lux-types --lib -- ids::bag::test_bag_add --exact --show-output
/// ref. "TestBagAdd"
#[test]
fn test_bag_add() {
    let id0 = Id::empty();
...
/// RUST_LOG=debug cargo test --package lux-types --lib -- ids::bag::test_bag_set_threshold --exact --show-output
...
/// RUST_LOG=debug cargo test --package lux-types --lib -- ids::bag::test_bag_filter --exact --show-output
/// ref. "TestBagFilter"
#[test]
fn test_bag_filter() {
    let id0 = Id::empty();
...
/// RUST_LOG=debug cargo test --package lux-types --lib -- ids::bag::test_bag_split --exact --show-output
/// ref. "TestBagSplit"
#[test]
fn test_bag_split() {
    let id0 = Id::empty();
...
/// ref. <https://pkg.go.dev/github.com/luxfi/node/ids#UniqueBag>
...
/// RUST_LOG=debug cargo test --package lux-types --lib -- ids::bag::test_unique_bag --exact --show-output
/// ref. "TestUniqueBag"
#[test]
fn test_unique_bag() {
    let ub1 = Unique::new();
...
/// RUST_LOG=debug cargo test --package lux-types --lib -- ids::bag::test_unique_bag_clear --exact --show-output
