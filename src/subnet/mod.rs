//! Lux Rust SDK: Types and building blocks to assist with creating a custom `subnet` VM.
//!
...
/// RUST_LOG=debug cargo test --package lux-types --lib -- subnet::test_vm_name_to_id --exact --show-output
#[test]
