...
/// ref. <https://github.com/luxfi/node/blob/v1.9.5/version/constants.go#L15-L17>
    ...
    V: Vm,
{
    ...
    // node currently only supports plugins listening on IP address.
    ...
    V: Vm,
{
    ...
    // TODO: remove this once go-plugin is deprecated in node
