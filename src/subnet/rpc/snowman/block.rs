...
/// ref. <https://pkg.go.dev/github.com/luxfi/node/snow/engine/snowman/block#ChainVm>
#[tonic::async_trait]
...
/// ref. <https://pkg.go.dev/github.com/luxfi/node/snow/engine/snowman/block#Getter>
#[tonic::async_trait]
pub trait Getter {
    type Block: snowman::Block;
...
/// ref. <https://pkg.go.dev/github.com/luxfi/node/snow/engine/snowman/block#Parser>
#[tonic::async_trait]
pub trait Parser {
    type Block: snowman::Block;
...
/// to an underlying vm.
///
/// ref. <https://pkg.go.dev/github.com/luxfi/node/snow/engine/snowman/block#Context>
pub struct Context {
...
///
/// ref. <https://pkg.go.dev/github.com/luxfi/node/snow/engine/snowman/block#BuildBlockWithContextChainVM>
#[tonic::async_trait]
...
/// ref. <https://pkg.go.dev/github.com/luxfi/node/snow/engine/snowman/block#WithVerifyContext>
#[tonic::async_trait]
...
///
/// ref <https://pkg.go.dev/github.com/luxfi/node/snow/engine/snowman/block#BatchedChainVM>
#[tonic::async_trait]
