...
/// ref. <https://pkg.go.dev/github.com/luxfi/node/snow/engine/common#NetworkAppHandler>
#[tonic::async_trait]
...
/// ref. <https://pkg.go.dev/github.com/luxfi/node/snow/engine/common#CrossChainAppHandler>
#[tonic::async_trait]
