...
/// of the Lux Network.
///
/// ref. <https://pkg.go.dev/github.com/luxfi/node/snow/validators#Validator>
#[derive(Clone, Debug)]
#[allow(dead_code)]
...
/// Contains the publicly relevant values of a validator of the Lux
/// Network for the output of GetValidator.
///
/// ref. <https://pkg.go.dev/github.com/luxfi/node/snow/validators#GetValidatorOutput>
...
///
/// ref. <https://pkg.go.dev/github.com/luxfi/node/snow/validators#State>
#[tonic::async_trait]
