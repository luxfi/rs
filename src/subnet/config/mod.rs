...
///
/// ref. <https://pkg.go.dev/github.com/luxfi/node/chains#SubnetConfig>
///
...
/// RUST_LOG=debug cargo test --package lux-types --lib -- subnet::config::test_config --exact --show-output
#[test]
fn test_config() {
