...
/// ref. <https://pkg.go.dev/github.com/luxfi/node/vms/components/lux#SortUTXOIDs>
/// RUST_LOG=debug cargo test --package lux-types --lib -- txs::utxo::test_sort_utxo_ids --exact --show-output
#[test]
...
/// RUST_LOG=debug cargo test --package lux-types --lib -- txs::utxo::test_utxo_id --exact --show-output
/// ref. "node/vms/components/lux.TestUTXOID"
#[test]
fn test_utxo_id() {
...
/// ref. <https://pkg.go.dev/github.com/luxfi/node/vms/components/lux#UTXO>
...
pub struct Utxo {
    ...
    /// LuxGo loads "lux.UTXO" object from the db and
...
/// RUST_LOG=debug cargo test --package lux-types --lib -- txs::utxo::test_utxo_unpack_hex --exact --show-output
#[test]
