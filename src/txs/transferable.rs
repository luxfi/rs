...
/// ref. <https://pkg.go.dev/github.com/luxfi/node/vms/components/lux#TransferableOut>
...
pub struct Output {
    ...
    /// Packer skips serialization due to serialize:"false" in node.
...
/// ref. <https://pkg.go.dev/github.com/luxfi/node/vms/components/lux#SortTransferableOutputs>
impl Ord for Output {
    fn cmp(&self, other: &Output) -> Ordering {
        ...
        // unlike "node", we want ordering without "codec" dependency and marshal-ing
...
/// ref. <https://pkg.go.dev/github.com/luxfi/node/vms/components/lux#SortTransferableOutputs>
/// ref. "node/vms/components/lux.TestTransferableOutputSorting"
/// RUST_LOG=debug cargo test --package lux-types --lib -- txs::transferable::test_sort_transferable_outputs --exact --show-output
#[test]
...
/// ref. <https://pkg.go.dev/github.com/luxfi/node/vms/components/lux#TransferableIn>
...
/// ref. <https://pkg.go.dev/github.com/luxfi/node/vms/components/lux#SortTransferableInputs>
///
/// ref. <https://pkg.go.dev/github.com/luxfi/node/vms/components/lux#SortTransferableInputsWithSigners>
impl Ord for Input {
...
/// ref. <https://pkg.go.dev/github.com/luxfi/node/vms/components/lux#SortTransferableInputs>
/// ref. <https://pkg.go.dev/github.com/luxfi/node/vms/components/lux#SortTransferableInputsWithSigners>
/// ref. "node/vms/components/lux.TestTransferableInputSorting"
/// RUST_LOG=debug cargo test --package lux-types --lib -- txs::transferable::test_sort_transferable_inputs --exact --show-output
#[test]
