...
/// ref. <https://pkg.go.dev/github.com/luxfi/node/snow/engine/lux/vertex#SortHashOf>
...
/// RUST_LOG=debug cargo test --package lux-types --lib -- txs::raw::test_sort --exact --show-output
#[test]
fn test_sort() {
