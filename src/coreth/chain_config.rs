...
/// ref. <https://pkg.go.dev/github.com/luxfi/coreth/plugin/evm#Config>
/// ref. <https://github.com/luxfi/coreth/blob/v0.11.5/plugin/evm/config.go>
...
/// $ vi /data/lux-configs/chains/C/config.json
///
...
/// ref. <https://docs.lux.network/nodes/maintain/run-offline-pruning>
...
impl Config {
    ...
    pub fn default() -> Self {
        Self {
            ...
            // ref. <https://pkg.go.dev/github.com/luxfi/coreth/core#DefaultTxPoolConfig>
...
/// RUST_LOG=debug cargo test --package lux-types --lib -- coreth::chain_config::test_config --exact --show-output
#[test]
fn test_config() {
