...
/// ref. <https://pkg.go.dev/github.com/luxfi/coreth/core#Genesis>
/// ref. <https://pkg.go.dev/github.com/luxfi/coreth/params#ChainConfig>
/// ref. <https://github.com/luxfi/node/tree/dev/genesis>
/// ref. <https://github.com/luxfi/lux-network-runner/blob/main/local/default/genesis.json>
...
impl Genesis {
    pub fn default() -> Self {
        ...
        alloc.insert(
            // ref. <https://github.com/luxfi/coreth/blob/v0.11.5/params/config.go>
            // ref. <https://github.com/luxfi/node/blob/master/genesis/genesis_local.json#L74>
...
/// ref. <https://pkg.go.dev/github.com/luxfi/coreth/core#GenesisAlloc>
/// ref. <https://pkg.go.dev/github.com/luxfi/coreth/core#GenesisAccount>
#[derive(Debug, Serialize, Deserialize, Eq, PartialEq, Clone)]
#[serde(rename_all = "camelCase")]
pub struct AllocAccount {
    ...
    /// ref. <https://pkg.go.dev/github.com/luxfi/coreth/core#GenesisMultiCoinBalance>
    #[serde(skip_serializing_if = "Option::is_none")]
