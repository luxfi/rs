...
/// RUST_LOG=debug cargo test --package lux-types --lib -- hash::test_sha256_ripemd160 --exact --show-output
#[test]
...
/// RUST_LOG=debug cargo test --package lux-types --lib -- hash::test_keccak256 --exact --show-output
#[test]
fn test_keccak256() {
